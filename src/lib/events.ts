...
export const ceremonies: CeremonyEvent[] = [
  {
    ...
    time: "6:00 PM",
    location: "708 Sam Davis Rd, Argyle, TX",
  ...
  {
    id: "groom_ceremony",
    name: "Groom Ceremony (Pellikoduku)",
    date: "Friday, May 8, 2026",
    time: "5:00 PM",
    location: "708 Sam Davis Rd, Argyle, TX",
    description: "An intimate Telugu tradition of adorning the groom with turmeric, oil, and blessings.",
    vibe: "Intimate groom-prep feeling, turmeric/oil blessings, silk attire cues, soft gold, jasmine.",
    ...
    visualPrompt: "Telugu Pellikoduku groom ceremony background, jasmine flowers, turmeric, silk fabric, soft gold, intimate family blessing mood, no people.",
    image: "/groom-ceremony-bg.png",
  },
  {
    id: "wedding",
    ...
    time: "9:30 AM",
    location: "Morgan Creek Barn, 1251 W Sherman Dr, Aubrey, TX",
